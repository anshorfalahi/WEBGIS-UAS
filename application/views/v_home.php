        ...
        <body>
          ...
          <!--Normale contenuto di -->
                  ...
                  <h1 class="text-center">WEB GIS UAS</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
        ...
        $.getJSON(base_url+"home/datamasjid", function(result){
          ...
          $.each(result, function(i, field){
            ...
            var detailmasjid = '<h6>'+namamasjid+'</h6><button type="button" class="btn btn-success btn-sm" onclick="calculateRoute()">Go to Masjid</button> ';
        ...
        // tes lat long pakai geolocation
        ...
        function calculateRoute() {
          ...
          routingControl = L.Routing.control({
            waypoints: [
              L.latLng(-3.6089295873902647, 114.70156341394882),
